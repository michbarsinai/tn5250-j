 ...
 *
 * Title: tn5250J
 * Copyright:   Copyright (c) 2001,2009, 2019
 * Company:
 * @author Tuxafgmur - Dhollmen
 * @Original author: master_jaf
 *
 * Description:
 *
...
/**
 * Testing the correctness of {@link CCSID1145} and comparing with existing implementation.
 *
 * @author Tuxafgmur - Dhollmen
 * @Original from master_jaf
 */
public class CCSID1145Test {
	 ...
	 */
	@Test
	public void testOldConverter1145() {

		ICodePage cp = CharMappings.getCodePage("1145");
	 ...
	 */
	@Test
	public void testNewConverter1145() {
		CCSID1145 cp = new CCSID1145();
		cp.init();
		assertNotNull("At least an ASCII Codepage should be available.", cp);
	...
	public void testBoth() {
		final ICodePage cp = CharMappings.getCodePage("1145");
		final CCSID1145 cpex = new CCSID1145();
		cpex.init();
